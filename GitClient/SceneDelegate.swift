...
extension SceneDelegate {
    func scene(_ scene: UIScene,
        ...
        window.rootViewController =  (GitHubCredintial.shared.accessToken == nil) ?
            Login.Builder.build()  :
            UINavigationController(rootViewController:Dashboard.Builder.build(with: GitHubCredintial.shared.accessToken ?? ""))
        self.window = window
